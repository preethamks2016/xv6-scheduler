...
int main(void){
  ...
  struct pstat* ps = (struct pstat*) malloc(sizeof(struct pstat));
  23:	e8 f8 06 00 00       	call   720 <malloc>
  ...
  getpinfo(ps);
  30:	e8 f6 03 00 00       	call   42b <getpinfo>
  for(int i=0; i<NPROC; i++) {
  35:	89 d8                	mov    %ebx,%eax
  37:	8d 9b 00 02 00 00    	lea    0x200(%ebx),%ebx
  3d:	83 c4 10             	add    $0x10,%esp
  40:	05 00 03 00 00       	add    $0x300,%eax
  getpinfo(ps);
  45:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
  48:	89 df                	mov    %ebx,%edi
  4a:	89 45 dc             	mov    %eax,-0x24(%ebp)
  4d:	89 c3                	mov    %eax,%ebx
  4f:	eb 0e                	jmp    5f <main+0x5f>
  51:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(int i=0; i<NPROC; i++) {
  58:	83 c7 04             	add    $0x4,%edi
  5b:	39 fb                	cmp    %edi,%ebx
  5d:	74 21                	je     80 <main+0x80>
    if(ps->pid[i] == mypid) {
  5f:	39 37                	cmp    %esi,(%edi)
  61:	75 f5                	jne    58 <main+0x58>
      printf(1, "intial ticks for myPid:%d is %d\n", mypid, ps->ticks[i]);
  63:	ff b7 00 01 00 00    	push   0x100(%edi)
  for(int i=0; i<NPROC; i++) {
  69:	83 c7 04             	add    $0x4,%edi
      printf(1, "intial ticks for myPid:%d is %d\n", mypid, ps->ticks[i]);
  6c:	56                   	push   %esi
  ...
  7e:	75 df                	jne    5f <main+0x5f>
    }
  }


  fork();
  80:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
  // if (rc==0) {
  //   settickets(0);
  // }
  ...
  fork();
  88:	e8 ee 02 00 00       	call   37b <fork>
  int rc = fork();
  8d:	e8 e9 02 00 00       	call   37b <fork>
  for(int i = 1; i < 250; i++){
  ...
  9f:	90                   	nop
  a0:	83 ff 64             	cmp    $0x64,%edi
  a3:	0f 94 c0             	sete   %al
        x += 1;
  a6:	83 c7 01             	add    $0x1,%edi
        if(i==100 && rc==0) settickets(0);
  a9:	84 45 e4             	test   %al,-0x1c(%ebp)
  ac:	75 62                	jne    110 <main+0x110>
        sleep(1);
  ae:	83 ec 0c             	sub    $0xc,%esp
  b1:	6a 01                	push   $0x1
  b3:	e8 5b 03 00 00       	call   413 <sleep>
  for(int i = 1; i < 250; i++){
  b8:	83 c4 10             	add    $0x10,%esp
  bb:	81 ff fa 00 00 00    	cmp    $0xfa,%edi
  ...
  c6:	ff 75 e0             	push   -0x20(%ebp)
  c9:	e8 5d 03 00 00       	call   42b <getpinfo>
  ce:	8b 7d dc             	mov    -0x24(%ebp),%edi
  d1:	83 c4 10             	add    $0x10,%esp
  d4:	eb 11                	jmp    e7 <main+0xe7>
  d6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  dd:	8d 76 00             	lea    0x0(%esi),%esi
  for(int i=0; i<NPROC; i++) {
  e0:	83 c3 04             	add    $0x4,%ebx
  e3:	39 df                	cmp    %ebx,%edi
  e5:	74 21                	je     108 <main+0x108>
    if(ps->pid[i] == mypid) {
  e7:	39 33                	cmp    %esi,(%ebx)
  e9:	75 f5                	jne    e0 <main+0xe0>
      printf(1, "final ticks for myPid:%d is %d\n", mypid, ps->ticks[i]);
  eb:	ff b3 00 01 00 00    	push   0x100(%ebx)
  for(int i=0; i<NPROC; i++) {
  f1:	83 c3 04             	add    $0x4,%ebx
      printf(1, "final ticks for myPid:%d is %d\n", mypid, ps->ticks[i]);
  f4:	56                   	push   %esi
  f5:	68 3c 08 00 00       	push   $0x83c
  fa:	6a 01                	push   $0x1
  fc:	e8 ef 03 00 00       	call   4f0 <printf>
 101:	83 c4 10             	add    $0x10,%esp
  for(int i=0; i<NPROC; i++) {
 104:	39 df                	cmp    %ebx,%edi
 106:	75 df                	jne    e7 <main+0xe7>
    }
  }
  exit();
 108:	e8 76 02 00 00       	call   383 <exit>
 10d:	8d 76 00             	lea    0x0(%esi),%esi
        if(i==100 && rc==0) settickets(0);
 110:	83 ec 0c             	sub    $0xc,%esp
 113:	6a 00                	push   $0x0
 115:	e8 09 03 00 00       	call   423 <settickets>
        sleep(1);
 11a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 121:	e8 ed 02 00 00       	call   413 <sleep>
 126:	83 c4 10             	add    $0x10,%esp
 129:	e9 72 ff ff ff       	jmp    a0 <main+0xa0>
 ...
 44c:	89 d1                	mov    %edx,%ecx
{
 ...
 479:	0f b6 92 bc 08 00 00 	movzbl 0x8bc(%edx),%edx
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 569:	ff 24 85 64 08 00 00 	jmp    *0x864(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 677:	90                   	nop
          s = "(null)";
 678:	ba 5c 08 00 00       	mov    $0x85c,%edx
        while(*s != 0){
 ...
 691:	a1 70 0b 00 00       	mov    0xb70,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 70 0b 00 00    	mov    %edx,0xb70
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 70 0b 00 00    	mov    %edx,0xb70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d 70 0b 00 00    	mov    0xb70,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d 70 0b 00 00    	mov    0xb70,%edi
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 70 0b 00 00    	mov    0xb70,%edx
 ...
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	bf 74 0b 00 00       	mov    $0xb74,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 78 0b 00 00 00 	movl   $0x0,0xb78
 802:	00 00 00 
    if(p->s.size >= nunits){
