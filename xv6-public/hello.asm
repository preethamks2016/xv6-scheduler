...
int main(void){
  ...
  12:	6a 00                	push   $0x0
  14:	e8 2a 03 00 00       	call   343 <settickets>
  struct pstat* ps = (struct pstat*) malloc(sizeof(struct pstat));
  19:	c7 04 24 00 04 00 00 	movl   $0x400,(%esp)
  20:	e8 1b 06 00 00       	call   640 <malloc>
  // struct pstat* ps = 0;
  getpinfo(ps);
  ...
  getpinfo(ps);
  2a:	e8 1c 03 00 00       	call   34b <getpinfo>
  printf(1, "psinfo ticket: %d\n", ps->tickets[0]);
  2f:	83 c4 0c             	add    $0xc,%esp
  32:	ff b3 00 01 00 00    	push   0x100(%ebx)
  38:	68 38 07 00 00       	push   $0x738
  3d:	6a 01                	push   $0x1
