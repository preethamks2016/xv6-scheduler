...
main(int argc, char *argv[])
{
  ...
  if(getpinfo(&st) == 0)
   e:	8d 85 f8 fb ff ff    	lea    -0x408(%ebp),%eax
{
  14:	81 ec 10 04 00 00    	sub    $0x410,%esp
  if(getpinfo(&st) == 0)
  1a:	50                   	push   %eax
  1b:	e8 2b 03 00 00       	call   34b <getpinfo>
  20:	83 c4 10             	add    $0x10,%esp
  23:	85 c0                	test   %eax,%eax
  25:	75 16                	jne    3d <main+0x3d>
  {
