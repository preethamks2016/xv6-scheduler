...
main(int argc, char *argv[]){
  ...
  11:	81 ec 18 04 00 00    	sub    $0x418,%esp
	int pid_par = getpid();
  17:	e8 c7 03 00 00       	call   3e3 <getpid>
	int tickets = 0;
  ...
  21:	89 c3                	mov    %eax,%ebx
	if(settickets(tickets) == 0)
  23:	e8 db 03 00 00       	call   403 <settickets>
  28:	83 c4 10             	add    $0x10,%esp
  2b:	85 c0                	test   %eax,%eax
  2d:	75 1f                	jne    4e <main+0x4e>
	{
	...
	if(fork() == 0){
  2f:	e8 27 03 00 00       	call   35b <fork>
  ...
  47:	7f f7                	jg     40 <main+0x40>
    exit();
  49:	e8 15 03 00 00       	call   363 <exit>
	 printf(1, "XV6_SCHEDULER\t FAILED\n");
  4e:	51                   	push   %ecx
  4f:	51                   	push   %ecx
  50:	68 f8 07 00 00       	push   $0x7f8
  55:	6a 01                	push   $0x1
  57:	e8 74 04 00 00       	call   4d0 <printf>
	 exit();
  5c:	e8 02 03 00 00       	call   363 <exit>
		int pid_chd = getpid();
  61:	e8 7d 03 00 00       	call   3e3 <getpid>
		if(getpinfo(&st) == 0)
  66:	83 ec 0c             	sub    $0xc,%esp
		int pid_chd = getpid();
  69:	89 c6                	mov    %eax,%esi
		if(getpinfo(&st) == 0)
  6b:	8d 85 e8 fb ff ff    	lea    -0x418(%ebp),%eax
  71:	50                   	push   %eax
  72:	e8 94 03 00 00       	call   40b <getpinfo>
  77:	83 c4 10             	add    $0x10,%esp
  7a:	85 c0                	test   %eax,%eax
  7c:	75 d0                	jne    4e <main+0x4e>
  7e:	8d 85 e8 fc ff ff    	lea    -0x318(%ebp),%eax
  84:	8d 8d e8 fd ff ff    	lea    -0x218(%ebp),%ecx
		int tickets_par = -1,tickets_chd = -1;
  8a:	83 cf ff             	or     $0xffffffff,%edi
  8d:	c7 85 e4 fb ff ff ff 	movl   $0xffffffff,-0x41c(%ebp)
  94:	ff ff ff 
  97:	eb 1a                	jmp    b3 <main+0xb3>
  99:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
			else if (st.pid[i] == pid_chd){
  a0:	39 f2                	cmp    %esi,%edx
  a2:	75 08                	jne    ac <main+0xac>
				tickets_chd = st.tickets[i];
  a4:	8b 10                	mov    (%eax),%edx
  a6:	89 95 e4 fb ff ff    	mov    %edx,-0x41c(%ebp)
		for(int i = 0; i < NPROC; i++){
  ac:	83 c0 04             	add    $0x4,%eax
  af:	39 c8                	cmp    %ecx,%eax
  b1:	74 13                	je     c6 <main+0xc6>
      			if (st.pid[i] == pid_par){
  b3:	8b 90 00 01 00 00    	mov    0x100(%eax),%edx
  b9:	39 da                	cmp    %ebx,%edx
  bb:	75 e3                	jne    a0 <main+0xa0>
				tickets_par = st.tickets[i];
  bd:	8b 38                	mov    (%eax),%edi
		for(int i = 0; i < NPROC; i++){
  bf:	83 c0 04             	add    $0x4,%eax
  c2:	39 c8                	cmp    %ecx,%eax
  c4:	75 ed                	jne    b3 <main+0xb3>
		printf(1, "parent: %d, child: %d\n", tickets_par, tickets_chd);
  c6:	8b b5 e4 fb ff ff    	mov    -0x41c(%ebp),%esi
  cc:	56                   	push   %esi
  cd:	57                   	push   %edi
  ce:	68 0f 08 00 00       	push   $0x80f
  d3:	6a 01                	push   $0x1
  d5:	e8 f6 03 00 00       	call   4d0 <printf>
		if(tickets_chd == tickets)
  da:	83 c4 10             	add    $0x10,%esp
  dd:	85 f6                	test   %esi,%esi
  df:	75 16                	jne    f7 <main+0xf7>
		 printf(1, "XV6_SCHEDULER\t SUCCESS\n");
  e1:	52                   	push   %edx
  e2:	52                   	push   %edx
  e3:	68 26 08 00 00       	push   $0x826
  e8:	6a 01                	push   $0x1
  ea:	e8 e1 03 00 00       	call   4d0 <printf>
  ef:	83 c4 10             	add    $0x10,%esp
  f2:	e9 52 ff ff ff       	jmp    49 <main+0x49>
		 printf(1, "XV6_SCHEDULER\t FAILED\n");
  f7:	50                   	push   %eax
  f8:	50                   	push   %eax
  f9:	68 f8 07 00 00       	push   $0x7f8
  fe:	6a 01                	push   $0x1
 100:	e8 cb 03 00 00       	call   4d0 <printf>
 105:	83 c4 10             	add    $0x10,%esp
 108:	e9 3c ff ff ff       	jmp    49 <main+0x49>
 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba 3e 08 00 00       	mov    $0x83e,%edx
        while(*s != 0){
 ...
 671:	a1 54 0b 00 00       	mov    0xb54,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 54 0b 00 00    	mov    %edx,0xb54
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 54 0b 00 00    	mov    %edx,0xb54
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 3d 54 0b 00 00    	mov    0xb54,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d 54 0b 00 00    	mov    0xb54,%edi
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 54 0b 00 00    	mov    0xb54,%edx
 ...
 7bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 54 0b 00 00 58 	movl   $0xb58,0xb54
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	bf 58 0b 00 00       	mov    $0xb58,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 58 0b 00 00 58 	movl   $0xb58,0xb58
 7d6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7db:	c7 05 5c 0b 00 00 00 	movl   $0x0,0xb5c
 7e2:	00 00 00 
    if(p->s.size >= nunits){
