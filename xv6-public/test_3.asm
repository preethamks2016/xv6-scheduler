...
{  
  ...
  if(settickets(0) == 0)
  11:	6a 00                	push   $0x0
  13:	e8 2b 03 00 00       	call   343 <settickets>
  ...
  else
  {
   ...
   exit();
  30:	e8 6e 02 00 00       	call   2a3 <exit>
   printf(1, "XV6_SCHEDULER\t FAILED\n");
  35:	50                   	push   %eax
  36:	50                   	push   %eax
  37:	68 50 07 00 00       	push   $0x750
  3c:	6a 01                	push   $0x1
  3e:	e8 cd 03 00 00       	call   410 <printf>
