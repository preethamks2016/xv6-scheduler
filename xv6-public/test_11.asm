...
main(int argc, char *argv[])
{
  ...
  13:	8b 59 04             	mov    0x4(%ecx),%ebx
   int ppid = getpid();
  16:	e8 38 03 00 00       	call   353 <getpid>
  1b:	89 c6                	mov    %eax,%esi

   if (fork() == 0) {     
  1d:	e8 a9 02 00 00       	call   2cb <fork>
  22:	85 c0                	test   %eax,%eax
  24:	75 37                	jne    5d <main+0x5d>
  ...
  42:	5a                   	pop    %edx
  43:	59                   	pop    %ecx
  44:	68 6c 07 00 00       	push   $0x76c
  49:	6a 01                	push   $0x1
  4b:	e8 f0 03 00 00       	call   440 <printf>
      
      kill(ppid);
  50:	89 34 24             	mov    %esi,(%esp)
  53:	e8 ab 02 00 00       	call   303 <kill>
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba 8d 07 00 00       	mov    $0x78d,%edx
        while(*s != 0){
